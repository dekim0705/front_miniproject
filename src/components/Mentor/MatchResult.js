...
const MatchResult = () => {
  ...
  return (
    <Container>
      <MessageContainer>
        <Svg fillColor="#3B74EC" duration={6} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'>
        ...
        <Svg fillColor="#00ACFF" duration={6} reverse viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
